    ...
    return (
      <Container>
        <div>
          ...
          <div className="flex flex-wrap justify-center items-center lg:gap-x-10 md:gap-x-8 gap-x-6">
            {categories?.map((category, idx) => (
              <div
                key={idx}
                className="flex  items-center justify-center bg-gradient-to-b from-transparent to-green-100 h-[250px] w-[190px] rounded-3xl"
              >
